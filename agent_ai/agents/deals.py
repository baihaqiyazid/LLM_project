...
feeds = [
        "https://www.dealnews.com/c191/Gaming-Toys/Video-Games/?rss=1",
        "https://www.dealnews.com/c187/Gaming-Toys/Computer-Games/?rss=1",
...
class ScrapedDeal:
    ...
    def __init__(self, entry: Dict[str, str]):
        ...
        content = soup.find('div', class_='content-section').get_text() if soup.find('div', class_='content-section') else ""
